...
\namesection{Sean}{Enck}{%
  \href{mailto:seanenck@gmail.com}{seanenck@gmail.com}
  | {PHONE}
  | {ADDRESS}%
}
...
GitLab \href{https://gitlab.com/enckse}{\custombold{enckse}} \\
Website:  \href{https://enck.network}{\custombold{enck.network}} \\
\sectionsep
...
\descript{Senior Staff Computer Scientist}
